...
export default function NotFound() {
  return (
    <section className="relative mt-24 z-10 bg-primary py-[120px]">
        ...
        <div className="-mx-4 flex">
          <div className="w-full px-4">
            <div className="mx-auto max-w-[400px] text-center">
              ...
              >
                Oops! Esa página no se puede encontrar.

              </h4>
              <p className="mb-8 text-lg text-white">
                 La página que estás buscando puedo ser eliminada.

              </p>
              <Link href="/" className="inline-block rounded-lg border border-white px-8 py-3 text-center text-base font-semibold text-white transition hover:bg-white hover:text-primary">
                Volver al inicio
              </Link>
            </div>
          </div>

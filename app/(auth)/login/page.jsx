        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            ...
            >
              ...
              <Link href="/forgot-password" className="mb-2 inline-block text-base text-dark hover:text-primary hover:underline">
                ¿Olvidaste la contraseña?
              </Link>
              
              <p className="text-base text-body-color">
                <span className="pr-0.5">¿No estás registrado aún?</span>

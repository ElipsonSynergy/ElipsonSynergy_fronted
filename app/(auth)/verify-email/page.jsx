          ...
          <div className="w-full px-4">
            ...
            >
              ...
              <div className="mt-4 flex items-center justify-between flex-col">
                <button onClick={() => resendEmailVerification({ setStatus })} className=" bg-gray-800 border  text-white  tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 w-full cursor-pointer rounded-md  px-5 py-3 text-base font-medium  transition hover:bg-opacity-90 mb-6">

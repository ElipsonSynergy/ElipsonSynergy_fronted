      ...
      <div className="container">
            ...
            <div className="flex flex-wrap -mx-4">
              <div className="w-full px-4 lg:w-8/12">
                <div>
                  ...
                  <h3 className="wow fadeInUp mb-6 text-2xl font-semibold text-dark sm:text-[28px] sm:leading-[40px]">
              ...
              <div className="w-full px-4 lg:w-4/12">
                <div>
                  ...
                  >
                    <h3
                      className={`${monserrat.className} mb-[6px] text-[28px] font-semibold leading-[40px] text-white`}
                    >
                      ¡Suscríbete a nuestro blog!
                    </h3>
                    <p className="mb-5 text-base text-white">
                      Ingresa tu correo para recivir nuestras últimas noticias.
                  ...
                  <div className="flex flex-wrap mb-8 -mx-4">
                    <div className="w-full px-4">
                      <h2
                        className={`${monserrat.className} wow fadeInUp relative pb-5 text-2xl font-semibold text-dark  sm:text-[28px]`}
                      >
                        Artículos Populares
                      </h2>
                      <span
        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-full px-4 wow fadeInUp mt-14" >
            <h2
              className={`${monserrat.className} relative pb-5 text-2xl font-semibold text-dark sm:text-[36px]`}
            >

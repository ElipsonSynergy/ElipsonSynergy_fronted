    ...
    <div className="relative z-10 overflow-hidden pt-[120px] pb-[60px] md:pt-[130px] lg:pt-[160px]">
        ...
        <div className="flex flex-wrap items-center -mx-4">
            ...
            <div className="text-center">
                ...
                <li>
                    <Link href="/blog" className="flex items-center gap-[10px] text-base font-medium text-body-color"> 
      ...
      <div className="mt-8 text-center wow fadeInUp" data-wow-delay=".2s">
        <div className="inline-flex p-3 bg-white border rounded-[10px] border-stroke">
          <ul className="flex items-center -mx-1">
            <li className="px-1">
              <a href=""
                className="flex items-center justify-center text-base bg-transparent border rounded-md hover:border-primary hover:bg-primary h-[34px] w-[34px] border-stroke text-body-color">
                <span>

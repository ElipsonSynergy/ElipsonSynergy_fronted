...
export default function Pricing() {
  return (
    <section className="relative z-10 overflow-hidden bg-white pb-12 pt-20 lg:pb-[90px] lg:pt-[20px]">
          ...
          <div className="w-full px-4">
            <div className="mx-auto mb-[60px] max-w-[510px] text-center">
              ...
              <p className="text-base text-body-color">
                ...
                de esta manera brindamos flexibilidad sin perder calidad.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="-mx-4 flex flex-wrap justify-center">
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <a
                href=""
                className="block w-full rounded-md border border-stroke bg-transparent p-3 text-center text-base font-medium text-primary transition hover:border-primary hover:bg-primary hover:text-white"
              >
                Choose Personal
              </a>

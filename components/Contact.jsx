        ...
        <div className="-mx-4 flex flex-wrap lg:justify-between">
          <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div className="mb-12 max-w-[570px] lg:mb-0">
              <span className={`${numans.className} mb-4 block text-base font-semibold text-primary`}>
                Contáctanos
              </span>
              <h2
                className={`${monserrat.className} mb-6 text-[32px] font-bold uppercase text-dark sm:text-[40px] lg:text-[36px] xl:text-[40px]`}
              >
                PONTE EN CONTACTO CON NOSOTROS

              </h2>
              <p
                className="mb-9 text-base leading-relaxed text-body-color"
              >

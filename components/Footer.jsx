      ...
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap">
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              <h4 className={`${numans.className} mb-9 text-lg font-semibold text-dark dark:text-white`}>
                Recursos
              </h4>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <div className="mb-6 flex items-center">
                <a
                  href="https://www.facebook.com/ElipsonSynergy"
                  target='_blank'
                ...
                <a
                  href="https://www.instagram.com/ElipsonSynergy"
                  target='_blank'
                  className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-dark hover:border-primary hover:bg-primary hover:text-white dark:border-dark-3 dark:text-white dark:hover:border-primary sm:mr-4 lg:mr-3 xl:mr-4"
                >
                ...
                <a
                  href="https://www.youtube.com/@ElipsonSynergy"
                  target='_blank'
                  className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-dark hover:border-primary hover:bg-primary hover:text-white dark:border-dark-3 dark:text-white dark:hover:border-primary sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                ...
                <a
                  href="https://www.linkedin.com/ElipsonSynergy"
                  target='_blank'
                  className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-dark hover:border-primary hover:bg-primary hover:text-white dark:border-dark-3 dark:text-white dark:hover:border-primary sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
              ...
              <p className={`${monserrat.className} text-base text-body-color dark:text-dark-6`}>
                &copy; {new Date().getFullYear()} Elipson Synergy
              </p>
            </div>
          </div>
        </div>
